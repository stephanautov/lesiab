(() => {
  ...
  ((a.id = 650),
    ...
    (a.modules = {
      ...
      16592: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 82058));
      },
      19121: (a) => {
        "use strict";
      ...
      20501: (a, b, c) => {
        ...
        let H = {
                    ...
                    children: [
                      "home",
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(c.bind(c, 71412)),
          ...
          I = ["C:\\Users\\seggu\\LESiAB\\app\\(protected)\\home\\page.tsx"],
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      71412: (a, b, c) => {
        ...
        let d = (0, c(78088).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"C:\\\\Users\\\\seggu\\\\LESiAB\\\\app\\\\(protected)\\\\home\\\\page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
          "C:\\Users\\seggu\\LESiAB\\app\\(protected)\\home\\page.tsx",
          "default",
      ...
      82058: (a, b, c) => {
        ...
        var e = c(61405),
          ...
          g = c(30520);
        function h() {
          let { data: a } = g.F.health.ping.useQuery();
                    ...
                    children: [
                      (0, d.jsxs)("li", {
                        children: [
                          ...
                          (0, d.jsx)("code", { children: "profile.json" }),
                          ".",
                        ],
                      }),
                      (0, d.jsxs)("li", {
                      ...
                      (0, d.jsx)("li", {
                        children:
                          "(Optional) Add login to protect these routes.",
                      }),
                    ],
                  }),
                ],
  ...
  b.C(a);
  var c = b.X(0, [767, 792, 280], () => b((b.s = 20501)));
  module.exports = c;
})();
