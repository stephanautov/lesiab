(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [751],
  {
    ...
    4516: (a, b, c) => {
      ...
      (c.r(f), c.d(f, { config: () => bp, middleware: () => bo }));
      let h = null;
      async function i() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
        ...
        formatPathname() {
          ...
          return (
            (b = (function (a, b, c, d) {
              if (!b || b === c) return a;
              let e = a.toLowerCase();
              return !d && (E(e, "/api") || E(e, "/" + b.toLowerCase()))
                ? a
                : C(a, "/" + b);
            })(
              (a = {
      ...
      class S extends Response {
        constructor(a, b = {}) {
          ...
          this[P] = {
            cookies: d,
            url: b.url
              ? new K(b.url, { headers: t(c), nextConfig: b.nextConfig })
              : void 0,
          };
        }
        [Symbol.for("edge-runtime.inspect.custom")]() {
        ...
        static redirect(a, b) {
          ...
          return (
            e.set("Location", u(a)),
            new S(null, { ...d, headers: e, status: c })
          );
        }
        static rewrite(a, b) {
          let c = new Headers(null == b ? void 0 : b.headers);
          return (
            c.set("x-middleware-rewrite", u(a)),
            R(b, c),
            new S(null, { ...b, headers: c })
          );
        }
        static next(a) {
      ...
      let az = (a, b) => {
          ((function (a) {
            return "object" == typeof a && null !== a && a instanceof ay;
          })(b) && b.bubble
        ...
        aA = new Map(),
        aB = d.createContextKey("next.rootSpanId"),
        aC = 0,
        aD = {
          set(a, b, c) {
      ...
      class aE {
        ...
        withPropagatedContext(a, b, c) {
          let d = as.active();
          if (au.getSpanContext(d)) return b();
          let e = at.extract(d, a, c);
          return as.with(e, b);
        }
        trace(...a) {
          var b;
          let [c, d, e] = a,
            ...
            h = g.spanName ?? c;
          if (
            (!ap.includes(c) && "1" !== process.env.NEXT_OTEL_VERBOSE) ||
            g.hideSpan
          )
            return f();
          let i = this.getSpanContext(
            ...
            j = !1;
          i
            ? (null == (b = au.getSpanContext(i)) ? void 0 : b.isRemote) &&
              (j = !0)
            : ((i = (null == as ? void 0 : as.active()) ?? ax), (j = !0));
          let k = aC++;
          return (
            (g.attributes = {
              "next.span_name": h,
            ...
            as.with(i.setValue(aB, k), () =>
              this.getTracerInstance().startActiveSpan(h, g, (a) => {
                ...
                j && aA.set(k, new Map(Object.entries(g.attributes ?? {})));
                try {
                  if (f.length > 1) return f(a, (b) => az(a, b));
                  let b = f(a);
                  if (ar(b))
                    return b
                      .then((b) => (a.end(), b))
        ...
        wrap(...a) {
          ...
          return ap.includes(c) || "1" === process.env.NEXT_OTEL_VERBOSE
            ? function () {
                let a = d;
                "function" == typeof a &&
                  "function" == typeof e &&
                ...
                {
                  let d = b.getContext().bind(as.active(), g);
                  return b.trace(
                    c,
                    a,
                    (a, b) => (
        ...
        getSpanContext(a) {
          return a ? au.setSpan(as.active(), a) : void 0;
        }
        getRootSpanAttributes() {
          let a = as.active().getValue(aB);
          return aA.get(a);
        }
        setRootSpanAttribute(a, b) {
          let c = as.active().getValue(aB),
            d = aA.get(c);
          d && d.set(a, b);
        }
      }
      ...
      class aH {
        constructor(a, b, c, d) {
          ...
          let f =
            ...
            g = null == (e = c.get(aG)) ? void 0 : e.value;
      ...
      let aQ = Symbol.for("@next/cache-handlers-map"),
        aR = Symbol.for("@next/cache-handlers-set"),
        aS = globalThis;
      function aT() {
      ...
      async function aX(a, b) {
        let c =
          ...
          e =
            ...
            [];
        return Promise.all([
          aW(c, a.incrementalCache),
          ...Object.values(d),
          ...e,
        ]);
      }
      let aY = Object.defineProperty(
        Error(
          "Invariant: AsyncLocalStorage accessed in runtime where it is not available",
        ),
        "__NEXT_ERROR_CODE",
      ...
      class a0 {
        ...
        addCallback(a) {
          ...
          let f =
            ((b = async () => {
              try {
                await a_.run({ rootTaskSpawnPhase: e }, () => a());
              } catch (a) {
                this.reportTaskError("function", a);
              }
            }),
            a$ ? a$.bind(b) : aZ.bind(b));
        ...
        async runCallbacks() {
          ...
          if (!a)
            throw Object.defineProperty(
              new aM("Missing workStore in AfterContext.runCallbacks"),
              "__NEXT_ERROR_CODE",
      ...
      let a8 = {
        ...
        a9 = (a, b) => aF().withPropagatedContext(a.headers, b, a8),
        ba = !1;
      async function bb(a) {
        var b;
        let d, e;
        if (
          !ba &&
          ((ba = !0), "true" === process.env.NEXT_PRIVATE_TEST_PROXY)
        ) {
          let { interceptTestApis: a, wrapRequestHandler: b } = c(2400);
          (a(), (a9 = b(a9)));
        }
        await l();
              ...
              return aF().trace(
                ...
                async () => {
                  try {
                              ...
                              if (b)
                                for (let [c, d] of b)
                                  "refreshTags" in d &&
                                    a.set(
                                      c,
                                      a2(async () => d.refreshTags()),
                                    );
                              return a;
                            })(),
                            runInCleanSnapshot: a$
                              ? a$.snapshot()
                              : function (a, ...b) {
                                  return a(...b);
                                },
                    ...
                    return await Z.I.run(p, () => aJ.e.run(n, a.handler, o, q));
                  } finally {
                    setTimeout(() => {
                      c.dispatchClose();
                    }, 0);
        ...
        return {
          ...
          waitUntil:
            ("internal" === q[x].kind
              ? Promise.all(q[x].promises).then(() => {})
              : void 0) ?? Promise.resolve(),
          fetchMetrics: o.fetchMetrics,
        };
      }
      (c(1113), "undefined" == typeof URLPattern || URLPattern);
      var bc = c(5742);
      if (
        (new WeakMap(),
        bc.unstable_postpone,
        !1 ===
          (function (a) {
            return (
              a.includes(
      ...
      function bo(a) {
        let b = a.nextUrl,
          c = b.pathname || "/";
        if (!c.startsWith("/app/(protected)")) return S.next();
        if (!a.cookies.get("sb-access-token")?.value) {
          let a = new URL("/login", b.origin);
          return (a.searchParams.set("redirect", c), S.redirect(a));
        }
        return S.next();
      }
      (bh("\x1b[90m", "\x1b[39m"),
        ...
        bk(bi("✓")),
        bm(bi("\xbb")),
        new aP(1e4, (a) => a.length),
        new WeakMap());
      let bp = { matcher: ["/app/(protected)/(.*)"] };
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let bq = { ...f },
        br = bq.middleware || bq.default,
        bs = "/middleware";
      if ("function" != typeof br)
        throw Object.defineProperty(
          Error(
            `The Middleware "${bs}" must export a \`middleware\` or a \`default\` function`,
          ),
          "__NEXT_ERROR_CODE",
