"use strict";exports.id=933,exports.ids=[933],exports.modules={80933:(a,b,c)=>{c.r(b),c.d(b,{AiLanggraphFlowNode:()=>e,default:()=>f});let d=`// path: lib/ai/flows/codegenFlow.ts
/**
...
`.replace(/\r\n/g,"\n"),e={id:"ai.langgraph.flow",phase:"codeGeneration",estimate:()=>({tokens:950,usd:.004}),async run(a,b){let c=`artifacts/${b.orchestrationId}/repo/lib/ai/flows/codegenFlow.ts`;return await b.storage.saveArtifact(c,d),b.logger.info({msg:"ai.langgraph.flow:written",files:[c],correlationId:b.correlationId}),{files:[c]}}},f=e}};