  ...
  [789],
  {
            ...
            let s = t.options,
              ...
              d = async () => {
                ...
                if (u && a.length) {
                  ...
                  let t = e ?? a.length;
                  do {
                    let e = 0 === h ? (l[0] ?? s.initialPageParam) : i(s, c);
                    if (h > 0 && null == e) break;
                    ((c = await p(c, e)), h++);
                  } while (h < t);
                }
    ...
    1129: (e, t, r) => {
      ...
      let A = (e, t, r) => {
          ...
          let s = t[t.length - 1];
          if ((y(n) ? (n[+s] = r(n[+s])) : p(n) && (n[s] = r(n[s])), b(n))) {
            let e = q(n, +s),
              t = r(e);
        ...
        U = (e, t, r, n, s = [], i = [], o = new Map()) => {
          ...
          if (!((e, t) => p(e) || y(e) || m(e) || b(e) || Q(e, t))(e, r)) {
            let t = k(e, r),
              n = t
                ? { transformedValue: t.value, annotations: [t.type] }
                : { transformedValue: e };
            return (u || o.set(e, n), n);
          }
          ...
          a(h, (u, l) => {
            ...
            let c = U(u, t, r, n, [...s, l], [...i, e], o);
            ((g[l] = c.transformedValue),
              y(c.annotations)
                ? (w[l] = c.annotations)
                : p(c.annotations) &&
                  a(c.annotations, (e, t) => {
      ...
      ((n = function (e) {
        ...
        (s = function (e) {
          return "Undefined" === F(e);
        }));
      class L {
        constructor({ dedupe: e = !1 } = {}) {
          ((this.classRegistry = new u()),
            (this.symbolRegistry = new o((e) => e.description ?? "")),
            (this.customTransformerRegistry = new h()),
            (this.allowedErrorProps = []),
            (this.dedupe = e));
        }
        serialize(e) {
          let t = new Map(),
            r = U(e, t, this, this.dedupe),
          ...
          let s = (function (e, t) {
            ...
            return (e.forEach((e) => {
              ...
              let [s, ...i] = e;
              0 === s.length ? (r = i.map(w)) : (n[w(s)] = i.map(w));
            }),
            r)
              ? f(n)
                ? [r]
        ...
        deserialize(e) {
              ...
              return N(t)
                ...
                : !(function (e) {
                  ...
                  : [
                      ...
                      if (N(r.props) && !r.props.includes(s)) return n;
                      let i = e(t[s], r);
                      var o = r.nonenumerable;
                      let u = {}.propertyIsEnumerable.call(t, s)
                        ? "enumerable"
                        : "nonenumerable";
                      return (
                        "enumerable" === u && (n[s] = i),
          ...
          return (
            i?.values &&
              ...
              (function e(t, r, n = []) {
                if (!t) return;
                if (!y(t)) return void a(t, (t, s) => e(t, r, [...n, ...x(s)]));
                let [s, i] = t;
                (i &&
                  a(i, (t, s) => {
                    e(t, r, [...n, ...x(s)]);
      ...
      ((L.defaultInstance = new L()),
        ...
        (L.registerClass = L.defaultInstance.registerClass.bind(
          L.defaultInstance,
        )),
        (L.registerSymbol = L.defaultInstance.registerSymbol.bind(
          L.defaultInstance,
        )),
        (L.registerCustom = L.defaultInstance.registerCustom.bind(
          L.defaultInstance,
        )),
        (L.allowErrorProps = L.defaultInstance.allowErrorProps.bind(
          L.defaultInstance,
        )),
        L.serialize,
        L.deserialize,
          ...
          async fetch(e, t) {
            ...
            let r = new AbortController(),
              ...
              o = () => {
                ...
                return ((this.#u = !1), this.options.persister)
            ...
            try {
              if (r) t();
                ...
                (this.#a({ type: "pending", variables: e, isPaused: n }),
                  await this.#c.config.onMutate?.(e, this));
    ...
    7628: (e, t, r) => {
      ...
      function c(e) {
          ...
          b = () => {
            ...
            Promise.resolve(t)
              ...
              .catch((t) => {
                ...
                let n = e.retry ?? 3 * !o.S$,
                  s = e.retryDelay ?? u,
                  i = "function" == typeof s ? s(c, t) : s,
                  a =
                    !0 === n ||
                    ("number" == typeof n && c < n) ||
                    ("function" == typeof n && n(c, t));
                if (r || !a) return void y(t);
                (c++,
                  e.onFail?.(c, t),
                  (0, o.yy)(i)
                    .then(() => (d() ? void 0 : m()))
        ...
        return {
          ...
          status: () => h.status,
          cancel: (t) => {
            "pending" === h.status && (y(new l(t)), e.abort?.());
          },
          continue: () => (t?.(), h),
          cancelRetry: () => {
            r = !0;
    ...
    8700: (e, t, r) => {
      ...
      var n = r(6906),
        ...
        i = new (class extends n.Q {
          ...
          onSubscribe() {
            this.#d || this.setEventListener(this.#p);
          }
          onUnsubscribe() {
    ...
    8832: (e, t, r) => {
      ...
      function h(e, t) {
        ...
        if (i) {
          ...
          } else if (!f(t.options.mutationKey, i)) return !1;
        }
    ...
    9668: (e, t, r) => {
      ...
      var l = Object.create,
        ...
        y = (e, t) =>
          function () {
            return (
              t || (0, e[d(e)[0]])((t = { exports: {} }).exports, t),
              t.exports
            );
          },
        m = (e, t, r) => (
          ...
          ((e, t, r, n) => {
            if ((t && "object" == typeof t) || "function" == typeof t)
              for (var s, i = d(t), o = 0, u = i.length; o < u; o++)
                ((s = i[o]),
                  f.call(e, s) ||
                    s === r ||
                    c(e, s, {
                      get: ((e) => t[e]).bind(null, s),
                      enumerable: !(n = h(t, s)) || n.enumerable,
                    }));
            return e;
          })(
            !t && e && e.__esModule
      ...
      function R(e, t, r) {
        ...
        if ("infinite" === r && o(t) && ("direction" in t || "cursor" in t)) {
          ...
          return [n, { input: (0, P.default)(t, E), type: "infinite" }];
        }
        return [
          n,
          (0, S.default)(
            (0, S.default)({}, void 0 !== t && t !== s.hT && { input: t }),
            r && "any" !== r && { type: r },
          ),
        ];
      }
      function C(e) {
        return R(e, void 0, "any");
      }
      var Q = Object.create,
        ...
        D = (e, t, r) => (
          ...
          ((e, t, r, n) => {
            if ((t && "object" == typeof t) || "function" == typeof t)
              for (var s, i = T(t), o = 0, u = i.length; o < u; o++)
                ((s = i[o]),
                  M.call(e, s) ||
                    s === r ||
                    _(e, s, {
      ...
      var z = D(N(), 1),
        ...
        H = class e extends Error {
          constructor(t, r) {
            ...
            (super(t, { cause: i }),
              (0, z.default)(this, "cause", void 0),
              (0, z.default)(this, "shape", void 0),
              (0, z.default)(this, "data", void 0),
              (0, z.default)(this, "meta", void 0),
          ...
          static from(t, r = {}) {
            return t instanceof H
              ...
              : o(t) &&
                ...
                ? new e(
                    t.error.message,
                    (0, B.default)((0, B.default)({}, r), {}, { result: t }),
                  )
                : new e(
                    "string" == typeof t
                      ? t
                      : o(t) && "string" == typeof t.message
                        ? t.message
                        : "Unknown error",
                    (0, B.default)((0, B.default)({}, r), {}, { cause: t }),
                  );
          }
        },
        V = D(L(), 1);
      ...
      async function X(e) {
        ...
        return (function (e) {
          ...
          method: null != (t = e.methodOverride) ? t : W[o],
          signal: e.signal,
          body: i,
          headers: a,
        });
      ...
      var et = Object.create,
        ...
        ea = (e, t, r) => (
          ...
          ((e, t, r, n) => {
            if ((t && "object" == typeof t) || "function" == typeof t)
              for (var s, i = es(t), o = 0, u = i.length; o < u; o++)
                ((s = i[o]),
                  eo.call(e, s) ||
                    s === r ||
                    er(e, s, {
                      get: ((e) => t[e]).bind(null, s),
                      enumerable: !(n = en(t, s)) || n.enumerable,
                    }));
            return e;
          })(
            !t && e && e.__esModule
      ...
      function ej(e) {
        ...
        let s = {
          ...
          i = null != (t = e.maxURLLength) ? t : 1 / 0,
          u = null != (r = e.maxItems) ? r : 1 / 0;
        return () => {
          let t = (t) => ({
              validate(e) {
                ...
                return (
                  J(
                    (0, ex.default)(
                      (0, ex.default)({}, s),
                      {},
                      { type: t, path: r, inputs: n, signal: null },
                    ),
                  ).length <= i
                );
              },
            ...
            r = { query: ew(t("query")), mutation: ew(t("mutation")) };
          return ({ op: e }) =>
            G((t) => {
              let n;
                  ...
                  .then((e) => {
                    ...
                    let r = (function (e, t) {
                      ...
                      if (
                        ...
                        throw new eg();
                      return r;
                    })(e.json, s.transformer.output);
                    if (!r.ok)
                      return void t.error(H.from(r.error, { meta: e.meta }));
                    (t.next({ context: e.meta, result: r.result }),
                      t.complete());
                  })
                  .catch((e) => {
                    t.error(H.from(e, { meta: null == n ? void 0 : n.meta }));
                  }),
                () => {}
              );
            });
      ...
      (D(L(), 1), Symbol());
      let eP = (e, ...t) => ("function" == typeof e ? e(...t) : e);
      async function eS(e) {
        let t = await eP(e.url);
      ...
      var eR = D(N(), 1),
        eC = class e {
          constructor(t) {
            var r;
            if (
              ((0, eR.default)(this, "id", ++e.connectCount),
              (0, eR.default)(this, "WebSocketPonyfill", void 0),
              (0, eR.default)(this, "urlOptions", void 0),
              (0, eR.default)(this, "keepAliveOpts", void 0),
              (0, eR.default)(
                this,
                "wsObservable",
                (function (e) {
              ...
              (0, eR.default)(this, "openPromise", null),
            ...
            t.openPromise = r.then(async (e) => {
              ((t.ws = e),
                ...
                t.urlOptions.connectionParams &&
                  e.send(await eE(t.urlOptions.connectionParams)));
            });
            try {
              await t.openPromise;
            } finally {
      ...
      ((0, eR.default)(eC, "connectCount", 0), D(N(), 1), D(L(), 1));
      var eQ = D(N(), 1),
        e_ = D(L(), 1),
        eI = class {
          constructor(e) {
            ((0, eQ.default)(this, "links", void 0),
              (0, eQ.default)(this, "runtime", void 0),
              (0, eQ.default)(this, "requestId", void 0),
              (this.requestId = 0),
              (this.runtime = {}),
      ...
      let eT = Symbol.for("trpc_untypedClient"),
        ek = { query: "query", mutate: "mutation", subscribe: "subscription" };
      function eM(e) {
        let t = eh(({ path: t, args: r }) => {
          let n = [...t],
            s = ek[n.pop()],
            i = n.join(".");
          return e[s](i, ...r);
        });
        return ed((r) => (r === eT ? e : t[r]));
      }
      function eq(e) {
        return eM(new eI(e));
      }
      ...
      (D(eD(), 1), D(eU(), 1), D(eF(), 1), D(L(), 1));
      var eN = r(8700),
        eL = r(3409),
        eG = r(4081),
        eK = r(6906),
        ez = r(1556),
        eB = class extends eK.Q {
          constructor(e, t) {
            (super(),
              (this.options = t),
              (this.#s = e),
          ...
          onSubscribe() {
            1 === this.listeners.size &&
              ...
              eH(this.#m, this.options) ? this.#C() : this.updateResult(),
              this.#Q());
          }
          onUnsubscribe() {
          ...
          shouldFetchOnReconnect() {
            return eV(this.#m, this.options, this.options.refetchOnReconnect);
          }
          shouldFetchOnWindowFocus() {
            return eV(this.#m, this.options, this.options.refetchOnWindowFocus);
          }
          destroy() {
            ((this.listeners = new Set()),
              this.#_(),
          ...
          setOptions(e) {
            ...
            if (
              ...
              void 0 !== this.options.enabled &&
                ...
                "boolean" != typeof (0, s.Eh)(this.options.enabled, this.#m))
            )
              throw Error(
            ...
            (n && eW(this.#m, r, this.options, t) && this.#C(),
              this.updateResult(),
              n &&
                (this.#m !== r ||
                  (0, s.Eh)(this.options.enabled, this.#m) !==
                    (0, s.Eh)(t.enabled, this.#m) ||
                  (0, s.d2)(this.options.staleTime, this.#m) !==
                    (0, s.d2)(t.staleTime, this.#m)) &&
                this.#k());
            let i = this.#M();
            n &&
              (this.#m !== r ||
          ...
          getOptimisticResult(e) {
            var t, r;
            let n = this.#s.getQueryCache().build(this.#s, e),
              i = this.createResult(n, e);
            return (
              (t = this),
              (r = i),
              (0, s.f8)(t.getCurrentResult(), r) ||
                ((this.#v = i),
                (this.#O = this.options),
                (this.#g = this.#m.state)),
              i
          ...
          fetchOptimistic(e) {
            let t = this.#s.defaultQueryOptions(e),
              r = this.#s.getQueryCache().build(this.#s, t);
            return r.fetch().then(() => this.createResult(r, t));
          }
          fetch(e) {
            return this.#C({ ...e, cancelRefetch: e.cancelRefetch ?? !0 }).then(
              () => (this.updateResult(), this.#v),
            );
          }
          #C(e) {
            this.#T();
            let t = this.#m.fetch(this.options, e);
            return (e?.throwOnError || (t = t.catch(s.lQ)), t);
          }
          #k() {
            this.#_();
            let e = (0, s.d2)(this.options.staleTime, this.#m);
            if (s.S$ || this.#v.isStale || !(0, s.gn)(e)) return;
            let t = (0, s.j3)(this.#v.dataUpdatedAt, e);
            this.#P = setTimeout(() => {
          ...
          #q(e) {
            (this.#I(),
              (this.#E = e),
              !s.S$ &&
                !1 !== (0, s.Eh)(this.options.enabled, this.#m) &&
                (0, s.gn)(this.#E) &&
                0 !== this.#E &&
                (this.#S = setInterval(() => {
          ...
          createResult(e, t) {
            ...
            if (t._optimisticResults) {
              let r = this.hasListeners(),
                s = !r && eH(e, t),
                o = r && eW(e, n, t, i);
              ((s || o) && (h = { ...h, ...(0, eG.k)(c.data, e.options) }),
                "isRestoring" === t._optimisticResults &&
                  (h.fetchStatus = "idle"));
            }
            let { error: p, errorUpdatedAt: f, status: y } = h;
            r = h.data;
            let m = !1;
            if (
              ...
              (o?.isPlaceholderData && t.placeholderData === a?.placeholderData
                ...
                : (e =
                    "function" == typeof t.placeholderData
                      ...
                      : t.placeholderData),
                void 0 !== e &&
                  ((y = "success"), (r = (0, s.pl)(o?.data, e, t)), (d = !0)));
            }
            if (t.select && void 0 !== r && !m)
              if (o && r === u?.data && t.select === this.#w) r = this.#x;
              else
                try {
                  ((this.#w = t.select),
                    (r = t.select(r)),
            ...
            this.#f &&
              ((p = this.#f), (r = this.#x), (f = Date.now()), (y = "error"));
            let b = "fetching" === h.fetchStatus,
              v = "pending" === y,
              g = "error" === y,
              O = v && b,
              w = void 0 !== r,
              x = {
                ...
                promise: this.#y,
                isEnabled: !1 !== (0, s.Eh)(t.enabled, e),
              };
          ...
          updateResult() {
            let e = this.#v,
              t = this.createResult(this.#m, this.options);
            if (
              ((this.#g = this.#m.state),
              (this.#O = this.options),
              void 0 !== this.#g.data && (this.#j = this.#m),
              (0, s.f8)(t, e))
            )
              return;
            this.#v = t;
            let r = () => {
              ...
              return (
                ...
                Object.keys(this.#v).some(
                  (t) => this.#v[t] !== e[t] && n.has(t),
                )
              );
            };
            this.#D({ listeners: r() });
      ...
      function eV(e, t, r) {
        if (
          !1 !== (0, s.Eh)(t.enabled, e) &&
          "static" !== (0, s.d2)(t.staleTime, e)
        ) {
          let n = "function" == typeof r ? r(e) : r;
          return "always" === n || (!1 !== n && e$(e, t));
        }
        return !1;
      }
      function eW(e, t, r, n) {
        return (
          (e !== t || !1 === (0, s.Eh)(n.enabled, e)) &&
      ...
      function e$(e, t) {
        return (
          !1 !== (0, s.Eh)(t.enabled, e) &&
          e.isStaleByTime((0, s.d2)(t.staleTime, e))
        );
      }
      var eJ = r(5931),
        eZ = r.t(eJ, 2),
        ...
        e3 = (e) => {
          ...
          return (
            ...
            !t.isFetching &&
            i &&
            ((o && void 0 === t.data) || (0, s.GU)(n, [t.error, i]))
          );
        },
        e7 = eJ.createContext(!1),
        e6 = () => eJ.useContext(e7);
      e7.Provider;
      var e9 = (e, t) => void 0 === t.state.data,
        ...
        e4 = (e, t) => e.isLoading && e.isFetching && !t,
        te = (e, t) => e?.suspense && t.isPending,
        tt = (e, t, r) =>
      ...
      function tr(e, t, r) {
        ...
        let l = e6(),
          c = e1(),
          h = (0, eY.jE)(r),
          d = h.defaultQueryOptions(e);
        (null == (i = h.getDefaultOptions().queries) ||
          null == (n = i._experimental_beforeQuery) ||
          n.call(i, d),
          (d._optimisticResults = l ? "isRestoring" : "optimistic"),
          e5(d),
          e2(d, c),
          e8(c));
        let p = !h.getQueryCache().get(d.queryHash),
          [f] = eJ.useState(() => new t(h, d)),
          y = f.getOptimisticResult(d),
          m = !l && !1 !== e.subscribed;
        if (
          (eJ.useSyncExternalStore(
            eJ.useCallback(
              (e) => {
                let t = m ? f.subscribe(eL.jG.batchCalls(e)) : s.lQ;
        ...
        if (
          ...
          throw y.error;
        if (
          (null == (u = h.getDefaultOptions().queries) ||
            null == (o = u._experimental_afterQuery) ||
            o.call(u, d, y),
          d.experimental_prefetchInRender && !s.S$ && e4(y, l))
        ) {
          let e = p
            ? tt(d, f, c)
            : null == (a = h.getQueryCache().get(d.queryHash))
              ? void 0
              : a.promise;
          null == e ||
        ...
        return d.notifyOnChangeProps ? y : f.trackResult(y);
      }
      var tn = r(4828),
        ts = class extends eK.Q {
          #s;
          #v = void 0;
          #A;
          #U;
          ...
          setOptions(e) {
            ...
            ((this.options = this.#s.defaultMutationOptions(e)),
              (0, s.f8)(this.options, t) ||
                this.#s.getMutationCache().notify({
                  type: "observerOptionsUpdated",
                  mutation: this.#A,
                  observer: this,
                }),
          ...
          mutate(e, t) {
            return (
              ...
              (this.#A = this.#s
                .getMutationCache()
                .build(this.#s, this.options)),
              this.#A.addObserver(this),
              this.#A.execute(e)
            );
          }
          #F() {
            let e = this.#A?.state ?? (0, tn.$)();
            this.#v = {
              ...e,
          ...
          #D(e) {
            eL.jG.batch(() => {
              if (this.#U && this.hasListeners()) {
                let t = this.#v.variables,
                  r = this.#v.context;
                e?.type === "success"
                  ? (this.#U.onSuccess?.(e.data, t, r),
                    this.#U.onSettled?.(e.data, null, t, r))
                  : e?.type === "error" &&
                    (this.#U.onError?.(e.error, t, r),
                    this.#U.onSettled?.(void 0, e.error, t, r));
              }
              this.listeners.forEach((e) => {
                e(this.#v);
              });
        ...
        to = class extends eB {
          ...
          setOptions(e) {
            super.setOptions({ ...e, behavior: (0, ti.PL)() });
          }
          getOptimisticResult(e) {
            return ((e.behavior = (0, ti.PL)()), super.getOptimisticResult(e));
          }
          fetchNextPage(e) {
            return this.fetch({
              ...e,
          ...
          createResult(e, t) {
            let { state: r } = e,
              ...
              a = r.fetchMeta?.fetchMore?.direction,
              l = o && "forward" === a,
              c = s && "forward" === a,
              h = o && "backward" === a,
              d = s && "backward" === a;
      ...
      var ta = class extends eK.Q {
        ...
        getOptimisticResult(e, t) {
          ...
          return [n, (e) => this.#$(e ?? n, t), () => this.#J(n, r)];
        }
        #J(e, t) {
          return t.map((r, n) => {
            let s = e[n];
        ...
        #$(e, t) {
          return t
            ? ((this.#K && this.#N === this.#B && t === this.#z) ||
                ((this.#z = t),
                (this.#B = this.#N),
                (this.#K = (0, s.BH)(this.#K, t(e)))),
              this.#K)
            : e;
        }
        #W(e) {
        ...
        #D() {
          if (this.hasListeners()) {
            let e = this.#K,
              t = this.#J(this.#N, this.#H);
            e !== this.#$(t, this.#G?.combine) &&
              eL.jG.batch(() => {
                this.listeners.forEach((e) => {
                  e(this.#N);
                });
      ...
      function tl(e, t) {
          ...
          a = eJ.useMemo(
            () =>
              r.map((e) => {
                ...
                return (
                  (t._optimisticResults = o ? "isRestoring" : "optimistic"),
                  t
                );
              }),
            [r, i, o],
        ...
        (a.forEach((e) => {
          ...
          e8(u));
        let [l] = eJ.useState(() => new ta(i, a, n)),
          [c, h, d] = l.getOptimisticResult(a, n.combine),
          p = !o && !1 !== n.subscribed;
        (eJ.useSyncExternalStore(
          eJ.useCallback(
            (e) => (p ? l.subscribe(eL.jG.batchCalls(e)) : s.lQ),
            [l, p],
          ),
          () => l.getCurrentResult(),
          () => l.getCurrentResult(),
        ...
        let f = c.some((e, t) => te(a[t], e))
          ? c.flatMap((e, t) => {
              let r = a[t];
              if (r) {
                let t = new eB(i, r);
                if (te(r, e)) return tt(r, t, u);
                e4(e, o) && tt(r, t, u);
              }
              return [];
            })
        ...
        if (null == y ? void 0 : y.error) throw y.error;
        return h(d());
      }
      let tc = ["client", "ssrContext", "ssrState", "abortOnUnmount"],
        th = null == (n = eJ.createContext) ? void 0 : n.call(eZ, null);
      var td = m(j(), 1);
      function tp(e) {
        let t = e instanceof eI ? e : e[eT];
        return eh((e) => {
          let r = e.path,
            n = r.join("."),
            [s, i] = e.args;
      ...
      var tO = m(j(), 1),
        tw = m(j());
      let tx = (e, t) => new Proxy(e, { get: (e, r) => (t(r), e[r]) });
      function tj(e) {
        return (function (e) {
          let t = eh(({ path: t, args: r }) => {
            var n;
            let s = [...t],
              i = s.pop();
            if ("useMutation" === i) return e[i](s, ...r);
                        ...
                        let t = eM(e.client),
                          r = eh((t) => {
                            ...
                            return {
                              ...
                              setMutationDefaults: () =>
                                e.setMutationDefaults(C(r), i),
                              getMutationDefaults: () =>
                                e.getMutationDefaults(C(r)),
                              isMutating: () =>
                                e.isMutating({ mutationKey: C(r) }),
                            }[n]();
                          });
                        return ed((n) =>
                          "client" === n ? t : tc.includes(n) ? e[n] : r[n],
                        );
                      })(t),
                    [t],
                  );
          ...
          (function (e) {
            ...
            let i =
                ...
                (t =
                  ...
                  ? t
                  : (e) => e.originalFn(),
              o = null != (n = null == e ? void 0 : e.context) ? n : th;
            function u() {
              let e = eJ.useContext(o);
              if (!e)
                throw Error(
            ...
            function l(e, t) {
              var r;
              let { queryClient: n, ssrState: s } = u();
              return s &&
                "mounted" !== s &&
                (null == (r = n.getQueryCache().find({ queryKey: e }))
                  ? void 0
                  : r.state.status) === "error"
                ? (0, tw.default)({ retryOnMount: !1 }, t)
                : t;
            }
            let c = { data: void 0, error: null, status: "idle" },
              h = { data: void 0, error: null, status: "connecting" };
            return {
              Provider: (e) => {
                var t;
                let {
                  ...
                  [u, l] = eJ.useState(null != (t = e.ssrState) && t),
                  c = e.client instanceof eI ? e.client : e.client[eT],
                  h = eJ.useMemo(
                    () =>
                      (function (e) {
                        let { client: t, queryClient: r } = e,
                          n = t instanceof eI ? t : t[eT];
                        return {
                            ...
                            return Object.assign(
                              (0, tO.default)(
                                ...
                                {},
                                {
                                  ...
                                  initialPageParam:
                                    null !=
                                    (o = null == r ? void 0 : r.initialCursor)
                                      ? o
                                      : null,
                                },
                              ),
                                ...
                                let o = (0, tO.default)(
                                    ...
                                    {},
                                    {
                                      trpc: (0, tO.default)(
                                        (0, tO.default)(
                                          {},
                                          null == i ? void 0 : i.trpc,
                                        ),
                                        (
                                          null == i || null == (s = i.trpc)
                                            ? void 0
                                            : s.abortOnUnmount
                                        )
                                          ? { signal: e.signal }
                                  ...
                                  u = await n.query(...ty(t, o));
                                return a(u) ? tg(u, r, t) : u;
                              };
                            return Object.assign(
                              (0, tO.default)(
                                (0, tO.default)({}, i),
                ...
                return (
                  ...
                  (0, eX.jsx)(o.Provider, { value: d, children: e.children })
                );
              },
              createClient: eq,
              useContext: u,
              ...
              useQuery: function (t, r, n) {
                ...
                let {
                  ...
                  v = R(t, r, "query"),
                  g = m.getQueryDefaults(v),
                  O = r === s.hT;
                "undefined" != typeof window ||
                  "prepass" !== y ||
                  (null == n || null == (i = n.trpc) ? void 0 : i.ssr) === !1 ||
                  (null != (o = null == n ? void 0 : n.enabled)
                    ? o
                    : null == g
                      ? void 0
                      : g.enabled) === !1 ||
                  O ||
                  m.getQueryCache().find({ queryKey: v }) ||
                  b(v, n);
                let w = l(v, (0, tw.default)((0, tw.default)({}, g), n)),
                  x =
                    null !=
                    (c =
                      null !=
                      (h =
                        null == n || null == (d = n.trpc)
                          ? void 0
                          : d.abortOnUnmount)
                        ? h
                        : null == e
                        ...
                        queryFn: O
                          ...
                          : async (e) => {
                              let t = (0, tw.default)(
                                ...
                                r = await f.query(...ty(v, t));
                              return a(r) ? tg(r, m, v) : r;
                            },
                      },
                    ),
                    eB,
              ...
              useSuspenseQuery: function (t, r, n) {
                ...
                return ((p.trpc = tv({ path: t })), [p.data, p]);
              },
              useQueries: (e, t) => {
                let {
                    ssrState: r,
              ...
              useSuspenseQueries: (e) => {
                var t;
                let { queryClient: r, client: n } = u(),
                  s =
                    ((t = {
                      queries: e(tp(n)).map((e) =>
                        (0, tw.default)(
                          (0, tw.default)({}, e),
                          {},
              ...
              useMutation: function (e, t) {
                let { client: r, queryClient: n } = u(),
                  o = C(e),
                  a = n.defaultMutationOptions(n.getMutationDefaults(o)),
                  l = (function (e, t) {
                    let r = (0, eY.jE)(t),
                      [n] = eJ.useState(() => new ts(r, e));
                    eJ.useEffect(() => {
                      n.setOptions(e);
                    }, [n, e]);
                    let i = eJ.useSyncExternalStore(
                        eJ.useCallback(
                          (e) => n.subscribe(eL.jG.batchCalls(e)),
                          [n],
                        ),
                        () => n.getCurrentResult(),
                        () => n.getCurrentResult(),
                      ...
                      o = eJ.useCallback(
                        (e, t) => {
                          n.mutate(e, t).catch(s.lQ);
                        },
                        [n],
                      );
                    if (i.error && (0, s.GU)(n.options.throwOnError, [i.error]))
                      throw i.error;
              ...
              useSubscription: function (e, t, r) {
                ...
                let [d] = eJ.useState(new Set([])),
                  ...
                  m = eJ.useCallback(() => {
                    var r;
                    if ((null == (r = f.current) || r.unsubscribe(), !i))
                      return void y(() =>
                        (0, tw.default)(
                          (0, tw.default)({}, c),
                          {},
                    ...
                    (y(() =>
                      (0, tw.default)((0, tw.default)({}, h), {}, { reset: m }),
                    ),
                      (f.current = a.subscription(
                        e.join("."),
                        null != t ? t : void 0,
                        {
                          onStarted: () => {
                            var e, t;
                            (null == (e = (t = l.current).onStarted) ||
                              e.call(t),
                              y((e) =>
                                (0, tw.default)(
                                  (0, tw.default)({}, e),
                ...
                eJ.useEffect(
                  () => (
                    ...
                    () => {
                      var e;
                      null == (e = f.current) || e.unsubscribe();
                    }
                  ),
                  [m],
                );
                let b = eJ.useRef(
                  ...
                  [v, g] = eJ.useState(tx(b.current, p));
                return v;
              },
              useInfiniteQuery: function (e, t, r) {
                ...
                "undefined" != typeof window ||
                  ...
                  (null != (i = null == r ? void 0 : r.enabled)
                    ? i
                    : null == b
                      ? void 0
                      : b.enabled) === !1 ||
                  ...
                  p(m, (0, tw.default)((0, tw.default)({}, b), r));
                let g = l(m, (0, tw.default)((0, tw.default)({}, b), r)),
                  O =
                    null !=
                    (o =
                      null == r || null == (a = r.trpc)
                        ? void 0
                        : a.abortOnUnmount)
                      ? o
                      : y,
                ...
                return ((w.trpc = tv({ path: e })), w);
              },
              usePrefetchInfiniteQuery: function (e, t, r) {
                var n, i, o;
                let a = u(),
                  c = R(e, t, "infinite"),
                  h = a.queryClient.getQueryDefaults(c),
                  d = t === s.hT,
                  p = l(c, (0, tw.default)((0, tw.default)({}, h), r)),
                  f =
                    null !=
                    (n =
              ...
              useSuspenseInfiniteQuery: function (e, t, r) {
                ...
                let c = u(),
                  ...
                  p = l(h, (0, tw.default)((0, tw.default)({}, d), r)),
                  f =
                    null !=
                    (n =
                      null == r || null == (s = r.trpc)
                  ...
                  y =
                    ...
                    (a = c.queryClient),
                    tr(
                      { ...o, enabled: !0, suspense: !0, throwOnError: e9 },
                      to,
                      a,
                    ));
                return ((y.trpc = tv({ path: e })), [y.data, y]);
              },
            };
          })(e),
        );
      ...
      var n = r(6906),
        ...
        i = new (class extends n.Q {
          ...
          setEventListener(e) {
            ((this.#p = e),
              this.#d?.(),
              (this.#d = e(this.setOnline.bind(this))));
          }
          setOnline(e) {
            this.#Z !== e &&
              ((this.#Z = e),
